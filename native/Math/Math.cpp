...
void Math::abs(KoalaJS* js, CScriptVar *c, void *userdata) {
	if ( scIsInt("a") ) {
...
void Math::round(KoalaJS* js, CScriptVar *c, void *userdata) {
	if ( scIsInt("a") ) {
...
void Math::min(KoalaJS* js, CScriptVar *c, void *userdata) {
...
void Math::max(KoalaJS* js, CScriptVar *c, void *userdata) {
	if ( (scIsInt("a")) && (scIsInt("b")) ) {
...
void Math::range(KoalaJS* js, CScriptVar *c, void *userdata) {
	if ( (scIsInt("x")) ) {
...
void Math::sign(KoalaJS* js, CScriptVar *c, void *userdata) {
	if ( scIsInt("a") ) {
